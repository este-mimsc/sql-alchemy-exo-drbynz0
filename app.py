    ...
    def init_db():
        ...
        if User.query.first() is None:
            with app.app_context():
                user1 = User(username="nizar", email="nizar@example.com")
                user2 = User(username="ibrahim", email="ibrahim@example.com")
                user3 = User(username="said", email="said@example.com")
                ...
                post1 = Post(
                    title="First Post",
                    content="This is Nizar's first post",
                    user_id=user1.id,
                )
                post2 = Post(
                    title="Hello World",
                    content="Ibrahim's introduction to blogging",
                    user_id=user2.id,
                )
                post3 = Post(
                    title="Learning SQLAlchemy",
                    content="Said explores database relationships",
                    user_id=user3.id,
                )
                post4 = Post(
                    title="Second Post",
                    content="Nizar's second post about Flask",
                    user_id=user1.id,
                )
